...
import { user_getAllUsers } from "../../../services/api/user/user.service";
...
const People = () => {
  ...
  const getAllUsers = useCallback(async () => {
    try {
      const response = await user_getAllUsers(currentPage);
  ...
  return (
    <div className="card-container" ref={bodyRef}>
      ...
      {!loading && !users.length && (
        <div className="empty-page">No user available</div>
      )}
