...
import SearchList from "../../chat/list/search-list/SearchList";
import { useCallback, useEffect, useState } from "react";
import { user_searchUsers } from "../../../services/api/user/user.service";
...
import ChatListBody from "../../chat/list/ChatListBody";
  ...
  const searchUsers = useCallback(
    async (query) => {
      ...
      try {
        setSearch(query);
        if (query) {
          const response = await user_searchUsers(query);
                ...
                >
                  ...
                  <div
                    className={`title-text ${
                      selectedUser && !data.body ? "selected-user-text" : ""
                    }`}
                  >
                    {data.receiverUsername !== profile?.username
